...
public class QuestionServiceTest implements IQuestionService {

    private final QuestionRepository questionRepository;

    public QuestionServiceTest(QuestionRepository questionRepository) {
        this.questionRepository = questionRepository;
    }

    @Override
    public Question createQuestion(Question question) {
        // Directly save — JPA handles @ElementCollection lists automatically
